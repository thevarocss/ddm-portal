...
-- CONFIG
local spId      = os.getenv("MOSMS_SP_ID") or error("MOSMS_SP_ID environment variable not set")
local password  = os.getenv("MOSMS_PASSWORD") or error("MOSMS_PASSWORD environment variable not set")
local serviceId = os.getenv("MOSMS_SERVICE_ID") or error("MOSMS_SERVICE_ID environment variable not set")
local telco_url = os.getenv("MOSMS_TELCO_URL") or error("MOSMS_TELCO_URL environment variable not set")
...
local pg = pgmoon.new({
    ...
    database = os.getenv("DB_NAME") or "fusionpbx",
    user = os.getenv("DB_USER") or "fusionpbx",
    password = os.getenv("DB_PASSWORD") or error("DB_PASSWORD environment variable not set")
})

...
local pg_conn_str = "pgsql://hostaddr=127.0.0.1 dbname=fusionpbx user=fusionpbx password=DXHoVfKQGjS3EKUk8eGrfzTZ4 options='-c client_encoding=UTF8'"

local LOG_ENABLED = true
local LOG_FILE = "/var/log/freeswitch/ddm_ivr.log"
local BASE = "/var/lib/freeswitch/recordings/62.164.214.102/"
